...
napisa³em plik wsadowy set_up_filter.bat, który nale¿y uruchomiæ jako administrator. skopiuje on filtr do system32 i zatrejestruje
teraz w ustawieniach projektu w post operacjach wy³¹czy³em bezmyœln¹ próbê zarejestrowania filtru i nie sypie b³êdami

od teraz serwer uruchamia siê dopiero przy rozpoczêciu transformacji, ¿eby mo¿na by³o przed uruchomieniem ustawiæ we w³aœciwoœciach inny port tcp/ip
